    ...
    <footer className="bg-gray-900 text-gray-300 border-t border-gray-800">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="text-white font-bold text-lg mb-4">Kupado.sk</h3>
            <p className="text-sm mb-4 leading-relaxed">
              Moderný slovenský trh pre kúpu a predaj všetkého. Spájame kupujúcich a predajcov rýchlo, jednoducho a bezpečne.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <a href="mailto:info@kupado.sk" className="hover:text-emerald-400 transition-colors">
                  info@kupado.sk
                </a>
              </li>
              <li className="flex items-start gap-2">
